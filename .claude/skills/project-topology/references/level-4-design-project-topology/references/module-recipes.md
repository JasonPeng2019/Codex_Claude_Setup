...
ROOT/orchestrator authors the complete execution meaning before every worker dispatch. Each member
card, read with its governing instance contract, must give a non-review worker the concrete problem/activation fact,
