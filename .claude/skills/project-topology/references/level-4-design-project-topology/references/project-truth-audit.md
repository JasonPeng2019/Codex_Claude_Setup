...
can combine configured `MI-*` occurrences without copying module process. Record which changes are
...
12. candidate independent step boundaries and their public inputs/outputs.
