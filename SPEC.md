...
- Level 4 normally uses the concise durable plan above. When the host repository
  ...
  interfaces rather than copying module process. In this Generic workspace the
  formal authority graph is strictly ROOT/orchestrator to direct workers. Do not
  import that machinery into ordinary work merely because the task is serious.
