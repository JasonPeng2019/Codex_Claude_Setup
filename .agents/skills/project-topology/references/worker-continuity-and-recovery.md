...
in every card. A lane sub-orchestrator reports its trigger and retained state to
global ROOT; only global ROOT accepts the replacement plan. Preserve justified
bounded execution hierarchy without creating another orchestration tier.
