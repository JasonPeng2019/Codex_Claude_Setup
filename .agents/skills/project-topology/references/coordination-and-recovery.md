...
Direct dispatch from one delivery owner is the rule. The owner retains scope,
shared-resource, cross-lane, integration, live-operation, and final-acceptance
decisions. Workers do not manage or dispatch other workers.
