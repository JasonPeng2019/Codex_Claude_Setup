...
in-boundary findings. A material omission, contradiction, missing member card, bare `N/A`, `TBD`,
`TODO`, `UNKNOWN`, or appeal to worker judgment makes the dispatch undispatchable unless the selected
recipe explicitly permits and explains that N/A.
