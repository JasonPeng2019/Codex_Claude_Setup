...
The owning authority also predeclares any cheap-first cancellation predicate and every deterministic
check selection used by M04-A2/A3. The campaign executor may evaluate that predicate and launch the
named paths; an unexpected result that would require a different cancellation, check, surface, or
