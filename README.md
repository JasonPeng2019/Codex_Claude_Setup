...
Stop verifier, rejects export artifacts and user-specific absolute paths, and
parses PowerShell/Bash scripts when those native interpreters are available. On
Windows it deliberately selects Git Bash rather than the WSL launcher shim.
